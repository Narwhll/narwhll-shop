...
function showToast(title, message, type='normal', duration = 3000) {
    ...
    if (type === 'success') {
        ...
        toastComponent.style.border = '1px solid #60d88cff';
    } else if (type === 'error') {
    ...
    toastComponent.classList.remove('opacity-0', 'translate-y-[-100%]', 'z-30');
    toastComponent.classList.add('opacity-100', 'translate-y-0', 'z-50');

    setTimeout (() => {
        toastComponent.classList.remove('opacity-100', 'translate-y-0', 'z-50');
        toastComponent.classList.add('opacity-0', 'translate-y-[-100%]', 'z-30');
    }, duration);
